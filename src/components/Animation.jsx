  ...
  return (
    <div
      className={`p-6 rounded-xl mb-4 border transition-all duration-500 ease-out ${
        active
          ? "border-blue-500 bg-blue-900/30 text-white transform-none"
          : "border-transparent bg-gray-800/70 text-gray-300"
      }`}
    >
      <div className="flex items-start gap-4">
        <div
          className={`p-3 rounded-lg ${active ? "bg-blue-600" : "bg-gray-700"}`}
        >
          {icon}
        </div>
        <div>
    ...
    <ContainerScroll
      titleComponent={
        <h1 className="text-4xl font-bold text-white mb-4 text-center md:text-6xl">
          Meet EMO <br />
          <span className="special-font text-2xl md:text-3xl text-blue-500">
            EMO's Superpowers
          </span>
        </h1>
      }
